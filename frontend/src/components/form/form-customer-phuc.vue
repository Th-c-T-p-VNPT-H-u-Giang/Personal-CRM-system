    ...
    <form class="mt-2" method="post">
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="date" class="form-control" id="birthdate" v-model="viewData.customerInfo.birthday" required />
        </div>
      </div>
      <div class="form-group">
        <label for="address">Địa chỉ (<span style="color: red">*</span>)</label>
        <input type="text" class="form-control" id="address" v-model="viewData.customerInfo.address" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <input type="file" class="form-control" name="file" id="imageUpload" accept=".png, .jpg" :maxFileSize="1000000"
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="wor_work_history" v-model="viewData.customerCompany.name"
            required />
        </div>
        <div class="form-group col-md-6">
          <label for="wor_work_temp">Nhiệm kỳ</label>
          <input type="text" class="form-control" id="wor_work_temp" v-model="viewData.customerWork.work_temp" required />
        </div>
      </div>
      ...
      <div class="form">
        <div class="form-group">
          ...
          <textarea name="" class="form-control" v-model="viewData.customerWork.work_history" required></textarea>
        </div>
      </div>
      ...
      axios
        ...
        .then((customer) => {
          ...
          if (customer.data.error) {
            ...
            axios.post('http://localhost:3000/api/company_KHs/', { name: viewData.customerCompany.name })
              .then(customerCompanyRes => {
                console.log('Created company customer successfully', customerCompanyRes.data);
                if (customerCompanyRes.data.error) {
                  ...
                  axios.post('http://localhost:3000/api/customer_works/', object)
                    .then(res => {
