            ...
            <div v-if="isActive" id="assignment" class="collapse my-3">
             <div class="table-responsive">
              <Table
                ...
                :fields="['Ngày bắt đầu', 'Ngày kết thúc', 'Nội dung chăm sóc', 'Tên khách hàng', 'Chu kì', 'Trạng thái' , 'Lý do']"
                :labels="['start_date','end_date', 'content' ,'customerName','cycleName','statusName', 'statusReason']" 
                :borderTableAll="true"
