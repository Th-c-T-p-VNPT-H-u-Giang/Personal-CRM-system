...
const CustomerEvent = require("./app/routes/customer_event.route");
const CustomerHabit = require("./app/routes/customer_habit.route");
...
app.use("/api/customer_event", CustomerEvent);
app.use("/api/customer_habit", CustomerHabit);
